...
class DeliteSettings(Screen):
	skin = """
	<screen position="160,110" size="390,360" title="OpenBlackHole Extra Settings">
...
class BhMinidlna(Screen):
	skin = """
	<screen position="center,center" size="602,405" title="OpenBlackHole UPnP Minidlna Server Panel">
...
class DeliteInadyn(Screen):
	skin = """
	<screen position="120,70" size="480,410" title="OpenBlackHole E2 Inadyn Manager">
...
class DeliteInaSetup(Screen, ConfigListScreen):
	skin = """
	<screen position="140,120" size="440,300" title="OpenBlackHole E2 Inadyn Setup">
...
class DeliteInaLog(Screen):
	skin = """
	<screen position="140,120" size="440,300" title="OpenBlackHole E2 Inadyn Log">
...
class DeliteOpenvpn(Screen):
	skin = """
	<screen position="80,150" size="560,310" title="OpenBlackHole E2 OpenVpn Panel">
...
class DeliteVpnLog(Screen):
	skin = """
	<screen position="80,100" size="560,400" title="OpenBlackHole OpenVpn Log">
